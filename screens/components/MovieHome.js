import { View, Text, Image, TextInput, FlatList, TouchableOpacity, SafeAreaView } from 'react-native'
                        ...
                        <View className="items-center">
                            <View className="font-bold text-xl p-1 w-80 mb-5">
                                ...
                                <View className="flex-row items-center">
                                    <Text className="font-bold text-base text-gray-700">Language: </Text><Text className="text-gray-700 text-base">{item.language}</Text>
                                </View>
                                <View className="flex-row items-center">
                                    <Text className="font-bold text-base text-gray-700">IMDB: </Text><Text className="text-gray-700 text-base">{item.imdb}</Text>
                                </View>
